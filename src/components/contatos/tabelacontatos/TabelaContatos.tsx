...
interface TabelaContatosProps {
  dados: any[];
  onEditar: (item: any, index: number) => void;
  onDeletar: (index: number) => void;
}

export default function TabelaContatos({ dados, onEditar, onDeletar }: TabelaContatosProps) {
  return (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-slate-500 text-xs mt-0.5">
                      {item.emailCliente || "cliente@email.com"}
                    </p>
                    <p className="text-slate-500 text-xs mt-0.5">
                      {item.telefoneCliente || "(11) 99999-9999"}
                    </p>
                  </div>
                </div>
              </td>
